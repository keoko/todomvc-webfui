...
var todomvc_webfui = {dom:{}};
todomvc_webfui.dom.redraw_todo = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  cljs.core._lookup.call(null, c, "\ufdd0'completed", null);
  var d = cljs.core._lookup.call(null, c, "\ufdd0'title", null), c = cljs.core._lookup.call(null, c, "\ufdd0'id", null), e = cljs.core.truth_((new cljs.core.Keyword("\ufdd0'completed")).call(null, a)) ? cljs.core.ObjMap.fromObject(["\ufdd0'checked"], {"\ufdd0'checked":"checked"}) : cljs.core.ObjMap.EMPTY, f = cljs.core.truth_((new cljs.core.Keyword("\ufdd0'completed")).call(null, a)) ? cljs.core.ObjMap.fromObject(["\ufdd0'class"], {"\ufdd0'class":"completed"}) : cljs.core.ObjMap.EMPTY;
  return cljs.core.PersistentVector.fromArray(["\ufdd0'li", cljs.core.merge.call(null, f, cljs.core.truth_(b) ? cljs.core.ObjMap.fromObject(["\ufdd0'class"], {"\ufdd0'class":"editing"}) : cljs.core.ObjMap.EMPTY), cljs.core.PersistentVector.fromArray(["\ufdd0'div.view", cljs.core.ObjMap.fromObject(["\ufdd0'data-todo-id"], {"\ufdd0'data-todo-id":c}), cljs.core.PersistentVector.fromArray(["\ufdd0'input.toggle", cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'data-todo-id", "\ufdd0'type", 
  "\ufdd0'watch"], {"\ufdd0'data-todo-id":c, "\ufdd0'type":"checkbox", "\ufdd0'watch":"\ufdd0'toggle-completed"}), e)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'label", cljs.core.ObjMap.fromObject(["\ufdd0'data-todo-id", "\ufdd0'mouse"], {"\ufdd0'data-todo-id":c, "\ufdd0'mouse":"\ufdd0'enable-content"}), "" + cljs.core.str((new cljs.core.Keyword("\ufdd0'title")).call(null, a))], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'button.destroy", cljs.core.ObjMap.fromObject(["\ufdd0'data-todo-id", 
  "\ufdd0'mouse"], {"\ufdd0'data-todo-id":c, "\ufdd0'mouse":"\ufdd0'delete-todo"})], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'input.edit", cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'value", "\ufdd0'watch"], {"\ufdd0'id":[cljs.core.str("input_"), cljs.core.str(c)].join(""), "\ufdd0'value":d, "\ufdd0'watch":"\ufdd0'edit-todo"})], !0)], !0)
};
todomvc_webfui.dom.redraw_todo_clear = function(a) {
  return 0 < (new cljs.core.Keyword("\ufdd0'todo-completed")).call(null, a) ? cljs.core.PersistentVector.fromArray(["\ufdd0'button#clear-completed", cljs.core.ObjMap.fromObject(["\ufdd0'mouse"], {"\ufdd0'mouse":"\ufdd0'clear-todos"}), [cljs.core.str("Clear completed ("), cljs.core.str((new cljs.core.Keyword("\ufdd0'todo-completed")).call(null, a)), cljs.core.str(")")].join("")], !0) : cljs.core.PersistentVector.fromArray(["\ufdd0'span"], !0)
};
todomvc_webfui.dom.redraw_todo_count = function(a) {
  return 0 < (new cljs.core.Keyword("\ufdd0'todo-left")).call(null, a) ? cljs.core.PersistentVector.fromArray(["\ufdd0'span#todo-count", cljs.core.PersistentVector.fromArray(["\ufdd0'strong", "" + cljs.core.str((new cljs.core.Keyword("\ufdd0'todo-left")).call(null, a))], !0), [cljs.core.str(" "), cljs.core.str(1 === (new cljs.core.Keyword("\ufdd0'todo-left")).call(null, a) ? "item" : "items"), cljs.core.str(" left")].join("")], !0) : cljs.core.PersistentVector.fromArray(["\ufdd0'span"], !0)
};
todomvc_webfui.dom.render_all = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  cljs.core._lookup.call(null, b, "\ufdd0'checked-all", null);
  var c = cljs.core._lookup.call(null, b, "\ufdd0'edit", null), d = cljs.core._lookup.call(null, b, "\ufdd0'stats", null), b = cljs.core._lookup.call(null, b, "\ufdd0'todos", null), e = cljs.core._EQ_.call(null, cljs.core.count.call(null, b), (new cljs.core.Keyword("\ufdd0'todo-completed")).call(null, d)) ? cljs.core.ObjMap.fromObject(["\ufdd0'checked"], {"\ufdd0'checked":"checked"}) : cljs.core.ObjMap.EMPTY;
  console.log("todos->", cljs.core.pr_str.call(null, a));
  return cljs.core.PersistentVector.fromArray(["\ufdd0'div", cljs.core.PersistentVector.fromArray(["\ufdd0'section#todoapp", cljs.core.PersistentVector.fromArray(["\ufdd0'header#header", cljs.core.PersistentVector.fromArray(["\ufdd0'h1", "todos"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'input#new-todo", cljs.core.ObjMap.fromObject(["\ufdd0'placeholder", "\ufdd0'autofocus", "\ufdd0'watch"], {"\ufdd0'placeholder":"What needs to be done?", "\ufdd0'autofocus":!0, "\ufdd0'watch":"\ufdd0'new-todo"})], 
  !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'section#main", cljs.core.PersistentVector.fromArray(["\ufdd0'input#toggle-all", cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'type", "\ufdd0'watch"], {"\ufdd0'type":"checkbox", "\ufdd0'watch":"\ufdd0'toggle-all-completed"}), e)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'label", cljs.core.ObjMap.fromObject(["\ufdd0'for"], {"\ufdd0'for":"toggle-all"}), "Mark all as complete"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'ul#todo-list", 
  function g(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var b = cljs.core.first.call(null, a);
          return cljs.core.cons.call(null, todomvc_webfui.dom.redraw_todo.call(null, b, c === (new cljs.core.Keyword("\ufdd0'id")).call(null, b)), g.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
  }.call(null, b)], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'footer#footer", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":cljs.core.ObjMap.fromObject(["\ufdd0'display"], {"\ufdd0'display":0 < cljs.core.count.call(null, b) ? "block" : "none"})}), todomvc_webfui.dom.redraw_todo_count.call(null, d), todomvc_webfui.dom.redraw_todo_clear.call(null, d)], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'footer#info", cljs.core.PersistentVector.fromArray(["\ufdd0'p", 
  "Double-click to edit a todo"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'p", "Created by ", cljs.core.PersistentVector.fromArray(["\ufdd0'a", cljs.core.ObjMap.fromObject(["\ufdd0'href"], {"\ufdd0'href":"http://twitter.com/keoko"}), "Natxo Cabr\u00e9"], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'p", "Port of ", cljs.core.PersistentVector.fromArray(["\ufdd0'a", cljs.core.ObjMap.fromObject(["\ufdd0'href"], {"\ufdd0'href":"http://todomvc.com/vanilla-examples/vanillajs/"}), "VanillaJS TodoMVC"], 
  !0)], !0)], !0)], !0)
};
goog.disposable = {};
...
var webfui = {state_patches:{}};
webfui.state_patches.patch = function patch(b, c) {
  return cljs.core.truth_(c) ? cljs.core.map_QMARK_.call(null, b) ? cljs.core.into.call(null, cljs.core.ObjMap.EMPTY, function e(f) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, f)) {
          ...
          return cljs.core.cons.call(null, cljs.core.PersistentVector.fromArray([g, function() {
            var e = b.call(null, g), f = c.call(null, g);
            return cljs.core.truth_(cljs.core.truth_(e) ? f : e) ? patch.call(null, e, f) : cljs.core.contains_QMARK_.call(null, c, g) ? f : e
          }()], !0), e.call(null, cljs.core.rest.call(null, f)))
        }
        return null
      }
    }, null)
  }.call(null, clojure.set.union.call(null, cljs.core.set.call(null, cljs.core.keys.call(null, b)), cljs.core.set.call(null, cljs.core.keys.call(null, c))))) : cljs.core.vector_QMARK_.call(null, b) ? cljs.core.map_QMARK_.call(null, c) ? cljs.core.vec.call(null, cljs.core.map_indexed.call(null, function(b, f) {
    var g = c.call(null, b);
    return cljs.core.truth_(g) ? patch.call(null, f, g) : f
  }, b)) : c : c : b
};
goog.net.xpc = {};
...
webfui.utilities = {};
webfui.utilities.body = function() {
  return document.body
};
webfui.utilities.get_attribute = function(a, b) {
  return cljs.core.get_in.call(null, a, cljs.core.PersistentVector.fromArray([1, b], !0))
};
webfui.utilities.clicked = function(a, b) {
  var c = cljs.core._EQ_.call(null, a, b);
  return c ? cljs.core.not.call(null, webfui.utilities.get_attribute.call(null, a, "\ufdd0'active")) : c
};
/*
...
todomvc_webfui.utils = {};
todomvc_webfui.utils.get_uuid = function() {
...
todomvc_webfui.state = {};
todomvc_webfui.state.local_storage_name = "todos-webfui";
todomvc_webfui.state.compute_stats = function(a) {
  var b = cljs.core.count.call(null, a), c = cljs.core.count.call(null, cljs.core.filter.call(null, "\ufdd0'completed", a));
  return cljs.core.ObjMap.fromObject(["\ufdd0'total-todo", "\ufdd0'todo-left", "\ufdd0'todo-completed"], {"\ufdd0'total-todo":cljs.core.count.call(null, a), "\ufdd0'todo-left":b - c, "\ufdd0'todo-completed":c})
};
todomvc_webfui.state.compute_stats_BANG_ = function() {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0'stats"], !0), function() {
    return todomvc_webfui.state.compute_stats.call(null, (new cljs.core.Keyword("\ufdd0'todos")).call(null, cljs.core.deref.call(null, todomvc_webfui.state.my_state)))
  })
};
todomvc_webfui.state.test_state = function() {
  return cljs.core.reset_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'title", "\ufdd0'completed"], {"\ufdd0'id":1, "\ufdd0'title":"test 1", "\ufdd0'completed":!1}), cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'title", "\ufdd0'completed"], {"\ufdd0'id":2, "\ufdd0'title":"test 2", "\ufdd0'completed":!0}), cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'title", "\ufdd0'completed"], {"\ufdd0'id":3, "\ufdd0'title":"test 3", 
  "\ufdd0'completed":!0})], !0))
};
todomvc_webfui.state.init_state = function() {
  var a = localStorage.getItem(todomvc_webfui.state.local_storage_name);
  if(cljs.core.not.call(null, a)) {
    return cljs.core.ObjMap.fromObject(["\ufdd0'todos", "\ufdd0'stats"], {"\ufdd0'todos":cljs.core.PersistentVector.EMPTY, "\ufdd0'stats":todomvc_webfui.state.compute_stats.call(null, cljs.core.PersistentVector.EMPTY)})
  }
  a = clojure.walk.keywordize_keys.call(null, cljs.core.js__GT_clj.call(null, JSON.parse(a)));
  return cljs.core.ObjMap.fromObject(["\ufdd0'todos", "\ufdd0'stats"], {"\ufdd0'todos":a, "\ufdd0'stats":todomvc_webfui.state.compute_stats.call(null, a)})
};
todomvc_webfui.state.my_state = cljs.core.atom.call(null, todomvc_webfui.state.init_state.call(null));
todomvc_webfui.state.add_todo_BANG_ = function(a) {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0'todos"], !0), cljs.core.conj, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'title", "\ufdd0'completed"], {"\ufdd0'id":todomvc_webfui.utils.get_uuid.call(null), "\ufdd0'title":a, "\ufdd0'completed":!1}))
};
todomvc_webfui.state.save_todos = function() {
  var a = JSON.stringify(cljs.core.clj__GT_js.call(null, cljs.core.get_in.call(null, cljs.core.deref.call(null, todomvc_webfui.state.my_state), cljs.core.PersistentVector.fromArray(["\ufdd0'todos"], !0))));
  return localStorage.setItem(todomvc_webfui.state.local_storage_name, a)
};
todomvc_webfui.state.edit_todo_BANG_ = function(a, b) {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0'todos"], !0), function(c) {
    return cljs.core.map.call(null, function(c) {
      return cljs.core._EQ_.call(null, a, (new cljs.core.Keyword("\ufdd0'id")).call(null, c)) ? cljs.core.assoc.call(null, c, "\ufdd0'title", b) : c
    }, c)
  })
};
todomvc_webfui.state.remove_todo_by_id_BANG_ = function(a) {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0'todos"], !0), function(b) {
    return cljs.core.remove.call(null, function(b) {
      return cljs.core._EQ_.call(null, a, (new cljs.core.Keyword("\ufdd0'id")).call(null, b))
    }, b)
  })
};
todomvc_webfui.state.clear_todos_BANG_ = function() {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0'todos"], !0), function(a) {
    return cljs.core.remove.call(null, "\ufdd0'completed", a)
  })
};
todomvc_webfui.state.toggle_all_completed_BANG_ = function(a) {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0'todos"], !0), function(b) {
    return cljs.core.map.call(null, function(b) {
      return cljs.core.assoc.call(null, b, "\ufdd0'completed", a)
    }, b)
  })
};
todomvc_webfui.state.toggle_completed_BANG_ = function(a, b) {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0'todos"], !0), function(c) {
    return function e(c) {
      return new cljs.core.LazySeq(null, !1, function() {
        for(;;) {
          if(cljs.core.seq.call(null, c)) {
            ...
            return cljs.core.cons.call(null, cljs.core.not_EQ_.call(null, a, (new cljs.core.Keyword("\ufdd0'id")).call(null, g)) ? g : cljs.core.assoc.call(null, g, "\ufdd0'completed", b), e.call(null, cljs.core.rest.call(null, c)))
          }
          return null
        }
      }, null)
...
todomvc_webfui.state.refresh_data = function() {
  todomvc_webfui.state.save_todos.call(null);
  return todomvc_webfui.state.compute_stats_BANG_.call(null)
};
todomvc_webfui.state.reset_mark_edit_todo_BANG_ = function() {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.assoc, "\ufdd0'edit", null)
};
todomvc_webfui.state.mark_edit_todo_BANG_ = function(a) {
  return cljs.core.swap_BANG_.call(null, todomvc_webfui.state.my_state, cljs.core.assoc, "\ufdd0'edit", a)
};
...
webfui.html = {};
webfui.html.parsed_tagname = function(a, b, c) {
  this.tagname = a;
  this.id = b;
  this.classes = c
};
webfui.html.parsed_tagname.cljs$lang$type = !0;
webfui.html.parsed_tagname.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "webfui.html/parsed-tagname")
};
webfui.html.parsed_tagname.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "webfui.html/parsed-tagname")
};
webfui.html.parsed_html = function(a, b, c) {
  this.tagname = a;
  this.attributes = b;
  this.children = c
};
webfui.html.parsed_html.cljs$lang$type = !0;
webfui.html.parsed_html.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "webfui.html/parsed-html")
};
webfui.html.parsed_html.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "webfui.html/parsed-html")
};
webfui.html.parse_tagname = function(a) {
  var b = cljs.core.re_matches.call(null, /^([^.^#]+)(#([^.]+))?(\..+)?/, a);
  cljs.core.nth.call(null, b, 0, null);
  a = cljs.core.nth.call(null, b, 1, null);
  cljs.core.nth.call(null, b, 2, null);
  var c = cljs.core.nth.call(null, b, 3, null), b = cljs.core.nth.call(null, b, 4, null);
  return new webfui.html.parsed_tagname(cljs.core.keyword.call(null, a), cljs.core.truth_(c) ? cljs.core.keyword.call(null, c) : null, cljs.core.truth_(b) ? cljs.core.map.call(null, cljs.core.second, cljs.core.re_seq.call(null, /\.([^.]+)/, b)) : null)
};
var cache_3184 = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY);
webfui.html.parse_tagname_memoized = function(a) {
  var b = cljs.core.deref.call(null, cache_3184).call(null, a);
  if(cljs.core.truth_(b)) {
    return b
  }
  b = webfui.html.parse_tagname.call(null, a);
  cljs.core.swap_BANG_.call(null, cache_3184, cljs.core.assoc, a, b);
  return b
};
webfui.html.parse_element = function(a) {
  var b = cljs.core.nth.call(null, a, 0, null), a = cljs.core.nthnext.call(null, a, 1), b = webfui.html.parse_tagname_memoized.call(null, b), c = b.classes, d = b.id, b = b.tagname, e = cljs.core.ObjMap.EMPTY, c = cljs.core.truth_(c) ? cljs.core.assoc.call(null, e, "\ufdd0'class", cljs.core.apply.call(null, cljs.core.str, cljs.core.interpose.call(null, " ", c))) : e, d = cljs.core.truth_(d) ? cljs.core.assoc.call(null, c, "\ufdd0'id", d) : c, c = cljs.core.nth.call(null, a, 0, null), e = cljs.core.nthnext.call(null, 
  a, 1), d = cljs.core.map_QMARK_.call(null, c) ? cljs.core.PersistentVector.fromArray([cljs.core.merge.call(null, d, c), e], !0) : cljs.core.PersistentVector.fromArray([d, a], !0), a = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nth.call(null, d, 1, null);
  return new webfui.html.parsed_html(b, a, webfui.html.parse_html.call(null, d))
};
webfui.html.merge_strings = function merge_strings(b) {
  if(cljs.core.truth_(b)) {
    var c = cljs.core.nth.call(null, b, 0, null), d = cljs.core.nthnext.call(null, b, 1);
    if(cljs.core.truth_(d)) {
      var b = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nthnext.call(null, d, 1), e;
      e = (e = cljs.core.string_QMARK_.call(null, c)) ? cljs.core.string_QMARK_.call(null, b) : e;
      return e ? merge_strings.call(null, cljs.core.cons.call(null, [cljs.core.str(c), cljs.core.str(b)].join(""), d)) : cljs.core.cons.call(null, c, merge_strings.call(null, cljs.core.cons.call(null, b, d)))
    }
  }
  return b
};
webfui.html.parse_html = function parse_html(b) {
  return cljs.core.mapcat.call(null, function(b) {
    if(cljs.core.vector_QMARK_.call(null, b)) {
      return cljs.core.PersistentVector.fromArray([webfui.html.parse_element.call(null, b)], !0)
    }
    var d;
    d = (d = cljs.core.coll_QMARK_.call(null, b)) ? !cljs.core.string_QMARK_.call(null, b) : d;
    return d ? parse_html.call(null, b) : cljs.core.PersistentVector.fromArray([b], !0)
  }, webfui.html.merge_strings.call(null, b))
};
webfui.html.tag = function(a, b, c) {
  return cljs.core.truth_(cljs.core.PersistentHashSet.fromArray(["\ufdd0'br"]).call(null, a)) ? [cljs.core.str("<"), cljs.core.str(cljs.core.name.call(null, a)), cljs.core.str(b), cljs.core.str(">")].join("") : [cljs.core.str("<"), cljs.core.str(cljs.core.name.call(null, a)), cljs.core.str(b), cljs.core.str(">"), cljs.core.str(cljs.core.apply.call(null, cljs.core.str, c)), cljs.core.str("</"), cljs.core.str(cljs.core.name.call(null, a)), cljs.core.str(">")].join("")
};
webfui.html.pixels = function(a) {
  return[cljs.core.str(a.toFixed(3)), cljs.core.str("px")].join("")
};
webfui.html.render_css = function(a) {
  return cljs.core.apply.call(null, cljs.core.str, cljs.core.interpose.call(null, ";", function c(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var e = cljs.core.first.call(null, a), f = cljs.core.nth.call(null, e, 0, null), g = cljs.core.nth.call(null, e, 1, null);
          return cljs.core.cons.call(null, [cljs.core.str(cljs.core.name.call(null, f)), cljs.core.str(":"), cljs.core.str(cljs.core.keyword_QMARK_.call(null, g) ? cljs.core.name.call(null, g) : cljs.core.truth_(function() {
            var a = cljs.core.number_QMARK_.call(null, g);
            return a ? cljs.core.PersistentHashSet.fromArray("\ufdd0'bottom \ufdd0'width \ufdd0'top \ufdd0'right \ufdd0'left \ufdd0'line-height \ufdd0'height".split(" ")).call(null, f) : a
          }()) ? webfui.html.pixels.call(null, g) : g)].join(""), c.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
...
webfui.html.render_attribute_value = function(a, b) {
  return cljs.core.keyword_QMARK_.call(null, b) ? cljs.core.name.call(null, b) : cljs.core._EQ_.call(null, a, "\ufdd0'data") ? cljs.core.print_str.call(null, b) : cljs.core._EQ_.call(null, a, "\ufdd0'style") ? webfui.html.render_css.call(null, b) : b
};
webfui.html.render_attributes = function(a) {
    ...
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          ...
          return cljs.core.cons.call(null, [cljs.core.str(" "), cljs.core.str(cljs.core.name.call(null, f)), cljs.core.str('="'), cljs.core.str(webfui.html.render_attribute_value.call(null, f, e)), cljs.core.str('"')].join(""), c.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
...
webfui.html.html = function html(b) {
  if(cljs.core.instance_QMARK_.call(null, webfui.html.parsed_html, b)) {
    var c = b.tagname, d = b.attributes, b = b.children;
    return cljs.core.truth_(c) ? webfui.html.tag.call(null, c, cljs.core.truth_(d) ? webfui.html.render_attributes.call(null, d) : null, cljs.core.map.call(null, html, b)) : ""
  }
  return"" + cljs.core.str(b)
};
webfui.html.html_delta = function html_delta(b, c, d) {
  return cljs.core._EQ_.call(null, cljs.core.count.call(null, b), cljs.core.count.call(null, c)) ? (b = cljs.core.map.call(null, cljs.core.vector, b, c), cljs.core.every_QMARK_.call(null, function(b) {
    var c = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nth.call(null, b, 1, null), d;
    d = (d = cljs.core.instance_QMARK_.call(null, webfui.html.parsed_html, c)) ? cljs.core.instance_QMARK_.call(null, webfui.html.parsed_html, b) : d;
    return d ? cljs.core._EQ_.call(null, c.tagname, b.tagname) : cljs.core._EQ_.call(null, c, b)
  }, b) ? cljs.core.apply.call(null, cljs.core.concat, cljs.core.map_indexed.call(null, function(b, c) {
    var g = cljs.core.nth.call(null, c, 0, null), h = cljs.core.nth.call(null, c, 1, null);
    if(cljs.core.instance_QMARK_.call(null, webfui.html.parsed_html, g)) {
      var i = g.attributes, g = g.children, j = h.attributes, l = h.children, m = cljs.core.conj.call(null, d, b), h = cljs.core.not_EQ_.call(null, i, j) ? cljs.core.mapcat.call(null, function(b) {
        var c = i.call(null, b), d = j.call(null, b);
        return cljs.core.not.call(null, d) ? cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["\ufdd0'rem-att", m, b], !0)], !0) : cljs.core.not_EQ_.call(null, c, d) ? cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["\ufdd0'att", m, b, d], !0)], !0) : cljs.core.PersistentVector.EMPTY
      }, clojure.set.union.call(null, cljs.core.set.call(null, cljs.core.keys.call(null, i)), cljs.core.set.call(null, cljs.core.keys.call(null, j)))) : null, g = html_delta.call(null, g, l, m);
      return cljs.core.concat.call(null, h, g)
    }
    return null
  }, b)) : cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["\ufdd0'html", d, c], !0)], !0)) : cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["\ufdd0'html", d, c], !0)], !0)
};
webfui.html.unparse_html = function unparse_html(b) {
  var c;
  c = (c = cljs.core.string_QMARK_.call(null, b)) ? c : cljs.core.number_QMARK_.call(null, b);
  if(c) {
    return b
  }
  c = b.children;
  return cljs.core.vec.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([b.tagname, b.attributes], !0), cljs.core.map.call(null, unparse_html, c)))
};
webfui.dom_manipulation = {};
webfui.dom_manipulation.path_dom = function(a) {
  return cljs.core.drop.call(null, 3, cljs.core.reverse.call(null, function c(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      return cljs.core.truth_(a) ? cljs.core.cons.call(null, cljs.core.count.call(null, cljs.core.take_while.call(null, cljs.core.identity, cljs.core.iterate.call(null, function(a) {
        return a.previousSibling
      }, a))) - 1, c.call(null, a.parentNode)) : null
    }, null)
  }.call(null, a)))
};
webfui.dom_manipulation.select_path_html = function(a, b) {
  for(;;) {
    var c = cljs.core.seq.call(null, b);
    if(c) {
      var d = c, c = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nthnext.call(null, d, 1), a = c = cljs.core.nth.call(null, a.children, c), b = d
    }else {
      return a
    }
  }
};
webfui.dom_manipulation.resolve_target = function(a, b) {
  var c = webfui.dom_manipulation.path_dom.call(null, b), c = webfui.dom_manipulation.select_path_html.call(null, a, c);
  return webfui.html.unparse_html.call(null, c)
};
...
webfui.plugin.core.declare_events = function(a, b, c, d) {
  var e;
  e = a ? a.webfui$plugin$core$Plugin$declare_events$arity$4 : a;
  if(e) {
    return a.webfui$plugin$core$Plugin$declare_events$arity$4(a, b, c, d)
  }
  e = webfui.plugin.core.declare_events[goog.typeOf(null == a ? null : a)];
  if(!e && (e = webfui.plugin.core.declare_events._, !e)) {
    throw cljs.core.missing_protocol.call(null, "Plugin.declare-events", a);
  }
  return e.call(null, a, b, c, d)
};
webfui.plugin.core.fix_dom = function(a) {
  var b;
  b = a ? a.webfui$plugin$core$Plugin$fix_dom$arity$1 : a;
  if(b) {
    return a.webfui$plugin$core$Plugin$fix_dom$arity$1(a)
  }
  b = webfui.plugin.core.fix_dom[goog.typeOf(null == a ? null : a)];
  if(!b && (b = webfui.plugin.core.fix_dom._, !b)) {
    throw cljs.core.missing_protocol.call(null, "Plugin.fix-dom", a);
  }
  return b.call(null, a)
};
webfui.plugin.core.register_plugin = function(a) {
  return cljs.core.swap_BANG_.call(null, webfui.plugin.core.active_plugins, cljs.core.conj, a)
};
webfui.core = {};
webfui.core.body = function() {
  return document.body
};
webfui.core.select_path_dom = function(a, b) {
  for(;;) {
    var c = cljs.core.seq.call(null, b);
    if(c) {
      var d = c, c = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nthnext.call(null, d, 1), a = c = a.childNodes.item(c), b = d
    }else {
      return a
    }
  }
};
webfui.core.dom_ready_QMARK_ = function() {
  return cljs.core._EQ_.call(null, document.readyState, "complete")
};
webfui.core.dom_ready = function(a) {
  return window.onload = a
};
webfui.core.parsed_html_watcher = function(a, b, c, d) {
  a = webfui.html.html_delta.call(null, c.children, d.children, cljs.core.PersistentVector.EMPTY);
  for(a = cljs.core.seq.call(null, a);;) {
    if(a) {
      var d = cljs.core.first.call(null, a), b = cljs.core.nth.call(null, d, 0, null), e = cljs.core.nth.call(null, d, 1, null), c = cljs.core.nth.call(null, d, 2, null), d = cljs.core.nth.call(null, d, 3, null), e = webfui.core.select_path_dom.call(null, webfui.core.body.call(null), e), f = b;
      if(cljs.core._EQ_.call(null, "\ufdd0'html", f)) {
        e.innerHTML = cljs.core.apply.call(null, cljs.core.str, cljs.core.map.call(null, webfui.html.html, c))
      }else {
        if(cljs.core._EQ_.call(null, "\ufdd0'rem-att", f)) {
          e.removeAttribute(cljs.core.name.call(null, c))
        }else {
          if(cljs.core._EQ_.call(null, "\ufdd0'att", f)) {
            cljs.core._EQ_.call(null, c, "\ufdd0'value") ? e.value = "" + cljs.core.str(d) : e.setAttribute(cljs.core.name.call(null, c), webfui.html.render_attribute_value.call(null, c, d))
          }else {
  ...
  for(a = cljs.core.seq.call(null, cljs.core.deref.call(null, webfui.plugin.core.active_plugins));;) {
    if(a) {
      b = cljs.core.first.call(null, a), webfui.plugin.core.fix_dom.call(null, b), a = cljs.core.next.call(null, a)
    }else {
      return null
    }
  }
...
webfui.core.update_parsed_html_atom = function(a) {
  var b = webfui.html.parsed_html, c = cljs.core.ObjMap.EMPTY, d;
  d = (d = cljs.core.seq_QMARK_.call(null, a)) ? d : cljs.core.list_QMARK_.call(null, a);
  return new b("\ufdd0'body", c, d ? webfui.html.parse_html.call(null, a) : webfui.html.parse_html.call(null, cljs.core.list.call(null, a)))
};
webfui.core.html_watcher = function(a, b, c, d) {
  return cljs.core.swap_BANG_.call(null, webfui.core.parsed_html_atom, cljs.core.partial.call(null, webfui.core.update_parsed_html_atom, d))
};
webfui.core.dom_watchers = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY);
webfui.core.core_add_dom_watch = function(a, b) {
  return cljs.core.swap_BANG_.call(null, webfui.core.dom_watchers, cljs.core.assoc, a, b)
};
webfui.core.init_dom = function(a) {
  webfui.core.body.call(null);
  for(var b = cljs.core.seq.call(null, cljs.core.deref.call(null, webfui.plugin.core.active_plugins));;) {
    if(b) {
      var c = cljs.core.first.call(null, b);
      webfui.plugin.core.declare_events.call(null, c, webfui.core.body.call(null), webfui.core.dom_watchers, webfui.core.parsed_html_atom);
      b = cljs.core.next.call(null, b)
    }else {
      break
    }
  }
  cljs.core.add_watch.call(null, a, "\ufdd0'dom-watcher", webfui.core.html_watcher);
  cljs.core.add_watch.call(null, webfui.core.parsed_html_atom, "\ufdd0'parsed-html-watcher", webfui.core.parsed_html_watcher);
  return cljs.core.swap_BANG_.call(null, a, cljs.core.identity)
};
webfui.core.core_defdom = function(a) {
  return cljs.core.truth_(webfui.core.dom_ready_QMARK_.call(null)) ? webfui.core.init_dom.call(null, a) : webfui.core.dom_ready.call(null, cljs.core.partial.call(null, webfui.core.init_dom, a))
};
webfui.plugin.form_values = {};
webfui.plugin.form_values.input = function(a, b, c) {
  var d = c.target, b = webfui.dom_manipulation.resolve_target.call(null, cljs.core.deref.call(null, b), d), c = cljs.core.nth.call(null, b, 0, null), e = cljs.core.nth.call(null, b, 1, null), a = cljs.core.deref.call(null, a).call(null, cljs.core.keyword.call(null, (new cljs.core.Keyword("\ufdd0'watch")).call(null, e)));
  if(cljs.core.truth_(cljs.core.truth_(a) ? cljs.core.contains_QMARK_.call(null, cljs.core.PersistentHashSet.fromArray(["\ufdd0'textarea", "\ufdd0'input"]), c) : a)) {
    var f = d.value, c = cljs.core.update_in.call(null, b, cljs.core.PersistentVector.fromArray([1, "\ufdd0'value"], !0), function(a) {
      d.value = a;
      return f
    });
    return a.call(null, b, c)
...
webfui.plugin.form_values.form_values.cljs$lang$type = !0;
webfui.plugin.form_values.form_values.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "webfui.plugin.form-values/form-values")
};
webfui.plugin.form_values.form_values.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "webfui.plugin.form-values/form-values")
};
webfui.plugin.form_values.form_values.prototype.webfui$plugin$core$Plugin$ = !0;
webfui.plugin.form_values.form_values.prototype.webfui$plugin$core$Plugin$declare_events$arity$4 = function(a, b, c, d) {
  return b.addEventListener("input", cljs.core.partial.call(null, webfui.plugin.form_values.input, c, d))
};
webfui.plugin.form_values.form_values.prototype.webfui$plugin$core$Plugin$fix_dom$arity$1 = function() {
  return null
};
webfui.dom = {};
...
webfui.plugin.mouse.nodelist_to_seq = function(a) {
  return cljs.core.map.call(null, function(b) {
    return a.item(b)
  }, cljs.core.range.call(null, a.length))
};
webfui.plugin.mouse.offset = function offset(b) {
  var c = b.offsetParent;
  if(cljs.core.truth_(c)) {
    var d = offset.call(null, c), c = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nth.call(null, d, 1, null);
    return cljs.core.PersistentVector.fromArray([c + b.offsetLeft, d + b.offsetTop], !0)
  }
  return cljs.core.PersistentVector.fromArray([0, 0], !0)
};
webfui.plugin.mouse.all_elements_at_point = function(a) {
  return function c(d) {
    var e = cljs.core.nth.call(null, a, 0, null), f = cljs.core.nth.call(null, a, 1, null), g = cljs.core.mapcat.call(null, c, webfui.plugin.mouse.nodelist_to_seq.call(null, d.childNodes));
    return cljs.core.truth_(function() {
      var a = d.getBoundingClientRect;
      if(cljs.core.truth_(a)) {
        var a = d.getBoundingClientRect(), c = a.left <= e;
        return c && (c = a.top <= f) ? (c = a.right > e) ? a.bottom > f : c : c
      }
      return a
    }()) ? cljs.core.cons.call(null, d, g) : g
  }.call(null, webfui.utilities.body.call(null))
};
webfui.plugin.mouse.merge_data = function(a, b) {
  for(;;) {
    var c = b;
    if(cljs.core.truth_(c)) {
      var d = c, c = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nthnext.call(null, d, 1);
      if(!cljs.core.not.call(null, c)) {
        if(!cljs.core.not.call(null, a)) {
          var e;
          e = (e = cljs.core.map_QMARK_.call(null, c)) ? cljs.core.map_QMARK_.call(null, a) : e;
          e && (c = cljs.core.merge.call(null, a, c))
        }
        a = c
      }
      b = d
...
webfui.plugin.mouse.mouse_element = function(a, b) {
  var c = b.target, d = b.type;
  cljs.core.truth_(cljs.core.PersistentHashSet.fromArray(["touchstart"]).call(null, d)) ? (d = b.touches.item(0), d = cljs.core.PersistentVector.fromArray([d.clientX, d.clientY], !0)) : cljs.core.truth_(cljs.core.PersistentHashSet.fromArray(["touchmove"]).call(null, d)) ? (d = b.touches.item(0), d = cljs.core.PersistentVector.fromArray([d.clientX, d.clientY], !0)) : cljs.core._EQ_.call(null, "touchend", d) ? (d = b.changedTouches.item(0), d = cljs.core.PersistentVector.fromArray([d.clientX, d.clientY], 
  !0)) : d = cljs.core.PersistentVector.fromArray([b.clientX, b.clientY], !0);
  d = webfui.plugin.mouse.all_elements_at_point.call(null, d);
  d = webfui.plugin.mouse.merge_data.call(null, null, function f(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var b = cljs.core.first.call(null, a);
          return cljs.core.cons.call(null, function() {
            var a = b.getAttribute("data");
  ...
  return cljs.core.PersistentVector.fromArray([cljs.core.update_in.call(null, webfui.dom_manipulation.resolve_target.call(null, cljs.core.deref.call(null, a), c), cljs.core.PersistentVector.fromArray([1], !0), cljs.core.assoc, "\ufdd0'offset", webfui.plugin.mouse.offset.call(null, c), "\ufdd0'data", d), cljs.core.PersistentVector.fromArray([b.pageX, b.pageY], !0)], !0)
};
webfui.plugin.mouse.update_offset = function(a, b) {
  return cljs.core.update_in.call(null, a, cljs.core.PersistentVector.fromArray([1], !0), function(a) {
    return cljs.core.assoc.call(null, a, "\ufdd0'offset", webfui.plugin.mouse.offset.call(null, b), "\ufdd0'data", function() {
      var d = b.getAttribute("data");
      return cljs.core.truth_(d) ? cljs.reader.read_string.call(null, d) : (new cljs.core.Keyword("\ufdd0'data")).call(null, a)
    }())
  })
};
webfui.plugin.mouse.mouse_event = function(a) {
  return cljs.core.deref.call(null, webfui.plugin.mouse.mouse_watchers).call(null, cljs.core.get_in.call(null, a, cljs.core.PersistentVector.fromArray([1, "\ufdd0'mouse"], !0)))
};
webfui.plugin.mouse.add_mouse_watch = function(a, b) {
  return cljs.core.swap_BANG_.call(null, webfui.plugin.mouse.mouse_watchers, cljs.core.assoc, a, b)
};
webfui.plugin.mouse.mouse_down = function(a, b) {
  var c = b.target, d = webfui.plugin.mouse.mouse_element.call(null, a, b), e = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nth.call(null, d, 1, null), f = webfui.plugin.mouse.mouse_event.call(null, e);
  return cljs.core.truth_(f) ? (e = cljs.core.assoc_in.call(null, e, cljs.core.PersistentVector.fromArray([1, "\ufdd0'active"], !0), !0), webfui.plugin.mouse.mouse_down_element = e, webfui.plugin.mouse.mouse_down_target = c, webfui.plugin.mouse.points = cljs.core.PersistentVector.fromArray([d], !0), f.call(null, e, e, webfui.plugin.mouse.points)) : null
};
webfui.plugin.mouse.mouse_move = function(a, b) {
  b.preventDefault();
  if(cljs.core.truth_(webfui.plugin.mouse.mouse_down_element)) {
    var c = webfui.plugin.mouse.mouse_element.call(null, a, b), d = cljs.core.nth.call(null, c, 0, null), c = cljs.core.nth.call(null, c, 1, null), e = webfui.plugin.mouse.mouse_event.call(null, webfui.plugin.mouse.mouse_down_element);
    webfui.plugin.mouse.points = cljs.core.conj.call(null, webfui.plugin.mouse.points, c);
    return e.call(null, webfui.plugin.mouse.update_offset.call(null, webfui.plugin.mouse.mouse_down_element, webfui.plugin.mouse.mouse_down_target), d, webfui.plugin.mouse.points)
  }
  return null
};
webfui.plugin.mouse.mouse_up = function(a, b) {
  var c = webfui.plugin.mouse.mouse_element.call(null, a, b), d = cljs.core.nth.call(null, c, 0, null);
  cljs.core.nth.call(null, c, 1, null);
  if(cljs.core.truth_(webfui.plugin.mouse.mouse_down_element)) {
    var c = webfui.plugin.mouse.mouse_event.call(null, webfui.plugin.mouse.mouse_down_element), e = cljs.core.update_in.call(null, webfui.plugin.mouse.mouse_down_element, cljs.core.PersistentVector.fromArray([1], !0), function(a) {
      return cljs.core.dissoc.call(null, a, "\ufdd0'active")
    });
    c.call(null, webfui.plugin.mouse.update_offset.call(null, e, webfui.plugin.mouse.mouse_down_target), d, webfui.plugin.mouse.points);
...
webfui.plugin.mouse.mouse.cljs$lang$type = !0;
webfui.plugin.mouse.mouse.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "webfui.plugin.mouse/mouse")
};
webfui.plugin.mouse.mouse.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "webfui.plugin.mouse/mouse")
};
webfui.plugin.mouse.mouse.prototype.webfui$plugin$core$Plugin$ = !0;
webfui.plugin.mouse.mouse.prototype.webfui$plugin$core$Plugin$declare_events$arity$4 = function(a, b, c, d) {
  window.setTimeout(function() {
    return window.scrollTo(0, 1)
  }, 100);
  b.addEventListener("mousedown", cljs.core.partial.call(null, webfui.plugin.mouse.mouse_down, d));
  b.addEventListener("mousemove", cljs.core.partial.call(null, webfui.plugin.mouse.mouse_move, d));
  b.addEventListener("mouseup", cljs.core.partial.call(null, webfui.plugin.mouse.mouse_up, d));
  window.addEventListener("touchstart", cljs.core.partial.call(null, webfui.plugin.mouse.mouse_down, d));
  window.addEventListener("touchmove", cljs.core.partial.call(null, webfui.plugin.mouse.mouse_move, d));
  return window.addEventListener("touchend", cljs.core.partial.call(null, webfui.plugin.mouse.mouse_up, d))
};
webfui.plugin.mouse.mouse.prototype.webfui$plugin$core$Plugin$fix_dom$arity$1 = function() {
  return null
};
webfui.framework = {};
webfui.plugin.core.register_plugin.call(null, new webfui.plugin.mouse.mouse);
webfui.framework.state_watcher = function(a, b, c, d, e, f) {
  return cljs.core.swap_BANG_.call(null, a, cljs.core.constantly.call(null, b.call(null, f)))
};
webfui.framework.launch_app = function(a, b) {
  var c = cljs.core.atom.call(null, b.call(null, cljs.core.deref.call(null, a)));
  webfui.dom.defdom.call(null, c);
  cljs.core.add_watch.call(null, a, "\ufdd0'state-watcher", cljs.core.partial.call(null, webfui.framework.state_watcher, c, b));
  webfui.framework.cur_state = a
};
webfui.framework.add_dom_watch_helper = function(a, b) {
  return webfui.dom.add_dom_watch.call(null, a, function(a, d) {
    return cljs.core.swap_BANG_.call(null, webfui.framework.cur_state, function(a) {
      var c = b.call(null, a, d);
      return webfui.state_patches.patch.call(null, a, c)
    })
  })
};
webfui.framework.mouse_down_state = cljs.core.atom.call(null, null);
webfui.framework.add_mouse_watch_helper = function(a, b, c) {
  return webfui.plugin.mouse.add_mouse_watch.call(null, a, function(a, e, f) {
    cljs.core.swap_BANG_.call(null, webfui.framework.mouse_down_state, function(a) {
      return cljs.core.truth_(a) ? a : cljs.core.deref.call(null, webfui.framework.cur_state)
    });
    return cljs.core.reset_BANG_.call(null, webfui.framework.cur_state, cljs.core._EQ_.call(null, c, "\ufdd0'incremental") ? function() {
      var c = cljs.core.deref.call(null, webfui.framework.mouse_down_state), h = b.call(null, c, a, e, cljs.core.subvec.call(null, f, 0 > cljs.core.count.call(null, f) - 2 ? 0 : cljs.core.count.call(null, f) - 2)), c = webfui.state_patches.patch.call(null, c, h);
      cljs.core.reset_BANG_.call(null, webfui.framework.mouse_down_state, cljs.core.truth_(webfui.utilities.get_attribute.call(null, a, "\ufdd0'active")) ? c : null);
      return c
    }() : function() {
      var c = cljs.core.deref.call(null, webfui.framework.mouse_down_state), h = b.call(null, c, a, e, f);
      cljs.core.truth_(webfui.utilities.get_attribute.call(null, a, "\ufdd0'active")) || cljs.core.reset_BANG_.call(null, webfui.framework.mouse_down_state, null);
      return webfui.state_patches.patch.call(null, c, h)
    }())
  })
};
todomvc_webfui.watchers = {};
webfui.framework.add_dom_watch_helper.call(null, "\ufdd0'new-todo", function(a, b) {
  var c = webfui.utilities.get_attribute.call(null, b, "\ufdd0'value");
  todomvc_webfui.state.add_todo_BANG_.call(null, c);
  todomvc_webfui.state.refresh_data.call(null);
  return cljs.core.deref.call(null, todomvc_webfui.state.my_state)
});
webfui.framework.add_dom_watch_helper.call(null, "\ufdd0'edit-todo", function(a, b) {
  var c = webfui.utilities.get_attribute.call(null, b, "\ufdd0'id").slice(6), d = webfui.utilities.get_attribute.call(null, b, "\ufdd0'value");
  todomvc_webfui.state.edit_todo_BANG_.call(null, c, d);
  todomvc_webfui.state.reset_mark_edit_todo_BANG_.call(null);
  todomvc_webfui.state.refresh_data.call(null);
  return cljs.core.deref.call(null, todomvc_webfui.state.my_state)
});
webfui.framework.add_mouse_watch_helper.call(null, "\ufdd0'delete-todo", function(a, b, c) {
  return cljs.core.truth_(webfui.utilities.clicked.call(null, b, c)) ? (a = webfui.utilities.get_attribute.call(null, b, "\ufdd0'data-todo-id"), todomvc_webfui.state.remove_todo_by_id_BANG_.call(null, a), todomvc_webfui.state.refresh_data.call(null), cljs.core.deref.call(null, todomvc_webfui.state.my_state)) : null
}, "\ufdd0'full");
webfui.framework.add_mouse_watch_helper.call(null, "\ufdd0'clear-todos", function(a, b, c) {
  return cljs.core.truth_(webfui.utilities.clicked.call(null, b, c)) ? (todomvc_webfui.state.clear_todos_BANG_.call(null), todomvc_webfui.state.refresh_data.call(null), cljs.core.deref.call(null, todomvc_webfui.state.my_state)) : null
}, "\ufdd0'full");
webfui.framework.add_dom_watch_helper.call(null, "\ufdd0'toggle-all-completed", function(a, b) {
  var c = webfui.utilities.get_attribute.call(null, b, "\ufdd0'checked");
  todomvc_webfui.state.toggle_all_completed_BANG_.call(null, c);
  todomvc_webfui.state.refresh_data.call(null);
  return cljs.core.deref.call(null, todomvc_webfui.state.my_state)
});
webfui.framework.add_dom_watch_helper.call(null, "\ufdd0'toggle-completed", function(a, b) {
  var c = webfui.utilities.get_attribute.call(null, b, "\ufdd0'data-todo-id"), d = webfui.utilities.get_attribute.call(null, b, "\ufdd0'checked");
  todomvc_webfui.state.toggle_completed_BANG_.call(null, c, d);
  todomvc_webfui.state.refresh_data.call(null);
  return cljs.core.deref.call(null, todomvc_webfui.state.my_state)
});
webfui.framework.add_mouse_watch_helper.call(null, "\ufdd0'enable-content", function(a, b, c) {
  return cljs.core.truth_(webfui.utilities.clicked.call(null, b, c)) ? (a = webfui.utilities.get_attribute.call(null, b, "\ufdd0'data-todo-id"), todomvc_webfui.state.mark_edit_todo_BANG_.call(null, a), todomvc_webfui.state.refresh_data.call(null), cljs.core.deref.call(null, todomvc_webfui.state.my_state)) : null
}, "\ufdd0'full");
goog.dom = {};
...
var todo_webfui = {connect:{}};
todo_webfui.connect.connect = function() {
  console.log("about to connect to brepl");
  return clojure.browser.repl.connect.call(null, "http://localhost:9000/repl")
};
todomvc_webfui.plugin = {};
todomvc_webfui.plugin.checkbox = {};
todomvc_webfui.plugin.checkbox.input = function(a, b, c) {
  var d = c.target, b = webfui.dom_manipulation.resolve_target.call(null, cljs.core.deref.call(null, b), d), e = cljs.core.nth.call(null, b, 0, null), f = cljs.core.nth.call(null, b, 1, null), g = cljs.core.deref.call(null, a).call(null, cljs.core.keyword.call(null, (new cljs.core.Keyword("\ufdd0'watch")).call(null, f)));
  if(cljs.core.truth_(function() {
    if(cljs.core.truth_(g)) {
      var a = cljs.core.contains_QMARK_.call(null, cljs.core.PersistentHashSet.fromArray(["\ufdd0'input"]), e);
      return a ? cljs.core._EQ_.call(null, "checkbox", (new cljs.core.Keyword("\ufdd0'type")).call(null, f)) : a
    }
    return g
  }())) {
    var h = d.checked, a = cljs.core.update_in.call(null, b, cljs.core.PersistentVector.fromArray([1, "\ufdd0'checked"], !0), function(a) {
      d.checked = a;
      return h
    });
    return g.call(null, b, a)
  }
  return null
};
todomvc_webfui.plugin.checkbox.checkbox = function() {
};
todomvc_webfui.plugin.checkbox.checkbox.cljs$lang$type = !0;
todomvc_webfui.plugin.checkbox.checkbox.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "todomvc-webfui.plugin.checkbox/checkbox")
};
todomvc_webfui.plugin.checkbox.checkbox.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "todomvc-webfui.plugin.checkbox/checkbox")
};
todomvc_webfui.plugin.checkbox.checkbox.prototype.webfui$plugin$core$Plugin$ = !0;
todomvc_webfui.plugin.checkbox.checkbox.prototype.webfui$plugin$core$Plugin$declare_events$arity$4 = function(a, b, c, d) {
  return b.addEventListener("change", cljs.core.partial.call(null, todomvc_webfui.plugin.checkbox.input, c, d))
};
todomvc_webfui.plugin.checkbox.checkbox.prototype.webfui$plugin$core$Plugin$fix_dom$arity$1 = function() {
  return null
};
todomvc_webfui.plugin.input_text = {};
todomvc_webfui.plugin.input_text.enter_key = 13;
todomvc_webfui.plugin.input_text.input = function(a, b, c) {
  var d = c.target, e = c.keyCode, b = webfui.dom_manipulation.resolve_target.call(null, cljs.core.deref.call(null, b), d), f = cljs.core.nth.call(null, b, 0, null), c = cljs.core.nth.call(null, b, 1, null), g = cljs.core.deref.call(null, a).call(null, cljs.core.keyword.call(null, (new cljs.core.Keyword("\ufdd0'watch")).call(null, c)));
  if(cljs.core.truth_(function() {
    if(cljs.core.truth_(g)) {
      var a = cljs.core.contains_QMARK_.call(null, cljs.core.PersistentHashSet.fromArray(["\ufdd0'textarea", "\ufdd0'input"]), f);
      return a ? cljs.core._EQ_.call(null, todomvc_webfui.plugin.input_text.enter_key, e) : a
    }
    return g
  }())) {
    var h = d.value, a = cljs.core.update_in.call(null, b, cljs.core.PersistentVector.fromArray([1, "\ufdd0'value"], !0), function(a) {
      d.value = a;
      return h
    });
    return g.call(null, b, a)
...
todomvc_webfui.plugin.input_text.input1 = function() {
  return console.log("removing listener")
};
todomvc_webfui.plugin.input_text.input_text = function() {
};
todomvc_webfui.plugin.input_text.input_text.cljs$lang$type = !0;
todomvc_webfui.plugin.input_text.input_text.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "todomvc-webfui.plugin.input-text/input-text")
};
todomvc_webfui.plugin.input_text.input_text.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "todomvc-webfui.plugin.input-text/input-text")
};
todomvc_webfui.plugin.input_text.input_text.prototype.webfui$plugin$core$Plugin$ = !0;
todomvc_webfui.plugin.input_text.input_text.prototype.webfui$plugin$core$Plugin$declare_events$arity$4 = function(a, b, c, d) {
  return b.addEventListener("keypress", cljs.core.partial.call(null, todomvc_webfui.plugin.input_text.input, c, d))
};
todomvc_webfui.plugin.input_text.input_text.prototype.webfui$plugin$core$Plugin$fix_dom$arity$1 = function() {
  return null
};
todomvc_webfui.client = {};
cljs.core.reset_BANG_.call(null, webfui.plugin.core.active_plugins, cljs.core.PersistentVector.EMPTY);
webfui.plugin.core.register_plugin.call(null, new todomvc_webfui.plugin.input_text.input_text);
webfui.plugin.core.register_plugin.call(null, new webfui.plugin.mouse.mouse);
webfui.plugin.core.register_plugin.call(null, new todomvc_webfui.plugin.checkbox.checkbox);
webfui.framework.launch_app.call(null, todomvc_webfui.state.my_state, todomvc_webfui.dom.render_all);
